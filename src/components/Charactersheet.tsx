...
const Charactersheet: React.FC = () => {
  ...
  return (
    <div className="w-full px-5 pb-10 flex flex-col justify-center items-center bg-black">
      {/* <div className="w-[100%] px-5 flex flex-col justify-center items-center border-[4px] border-gray-200 my-8"> */}
        ...
        <div className="flex flex-col md:flex-row w-full gap-2">
          <div className="flex flex-col w-full md:w-[32%] ">
            <div className="flex gap-1 items-center justify-start">
              <img src="/arrow (1).png" alt="" className="w-9 h-9" />
              <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">PORTRAIT</p>
            </div>
          ...
          <div className="flex flex-col w-full md:w-[100%] ">
            ...
            <div className="flex flex-col sm:flex-row w-full md:w-full gap-2">
              <div className="flex flex-col w-full sm:w-1/2 md:w-[70%] ">
                <div className="flex gap-1 items-center justify-start">
                  <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                  <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">IDENTITY</p>
                </div>
                <div className="">
                  <Identity />
                </div>
              ...
              <div className="flex flex-col w-full sm:w-1/2 md:w-[30%] flex-2 ">
                <div className="flex gap-1 items-center justify-start">
                  <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                  <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">GEAR OF DENSTINY</p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row w-full gap-2 ">
              ...
              <div className="flex flex-col w-full  sm:w-[50%] mt-2">
                <div className="flex gap-1 items-center justify-start ">
                  <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                  <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">FACTION</p>
                </div>
                <Faction
              ...
              <div className="flex flex-col w-full sm:w-[50%] mt-2">
                <div className="flex gap-1 items-center justify-start  ">
                  <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                  <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">PERSONALITY</p>
                </div>
        ...
        <div className="flex flex-col md:flex md:flex-row w-full items-center justify-center h-full md:h-[160px] gap-2  md:mt-0">
          <div className="flex flex-col w-full h-full md:w-[62%]  mt-4">
            <div className="flex gap-1 items-center justify-start">
              <img src="/arrow (1).png" alt="" className="w-9 h-9" />
              <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">BACKSTORY</p>
            </div>
          ...
          <div className="flex flex-col w-full md:w-[37%]  mt-[20px]">
            <div className="flex flex-col">
              <div className="flex gap-1 items-center justify-start">
                <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">STRENGTHS</p>
              </div>
              <input type="text" className="w-full py-2 bg-black border-[2px] text-white border-gray-500" />
            </div>
            <div className="flex flex-col ">
              <div className="flex gap-1 items-center justify-start">
                <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">FLAWS</p>
              </div>
              <input type="text" className="w-full  py-2 bg-black border-[2px] text-white border-gray-500" />
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col px-2">
            <fieldset className="border-r-[2px] border-t-[2px] border-gray-500 ">
              <legend className="font-bold  flex  gap-1 items-center justify-start">
                <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">ESCAPE ARTISTS (ONLY)</p>
              </legend>
              ...
              <div className="w-full flex flex-col xl:flex-row gap-2 pr-2 mt-2">
                ...
                <div className="w-full xl:w-1/2 flex flex-col ">
                  ...
                  <div className="flex flex-col mt-6">
                    <div className="flex gap-1 items-center justify-start">
                      <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                      <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">Tours Configuration</p>
                    </div>
                    <input
                      type="text"
...
<div className="w-full flex  gap-4 mt-5 py-1 mx-[-5px] border-r-[2px]  border-t-[2px]  border-gray-500">
                ...
                <div className="w-1/2 flex flex-col mr-2 border-gray-500">
                  ...
                  {data.map((item) => (
                    ...
                    >
                      <p className="text-nowrap mt-[28px] text-[10px] md:text-xs lg:text-base text-gray-200">{item.name}</p>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            <fieldset className="border-r-[4px] border-t-[4px] border-gray-500 pr-2">
              <legend className="font-bold mb-2 flex  gap-1 items-center justify-start">
                <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">INK FIGHTERS (ONLY)</p>
              </legend>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            <fieldset className="border-r-[4px] border-t-[4px] border-gray-500 pr-2 mb-2 sm:mb-0">
              <legend className="font-bold mb-2 flex  gap-1 items-center justify-start">
                <img src="/arrow (1).png" alt="" className="w-9 h-9" />
                <p className="font-extrabold text-xs sm:text-sm md:text-base text-gray-200">OTHERS (ONLY)</p>
              </legend>
