...
const Input = React.forwardRef(
  (
    ...
    return (
      <div
        className={` ${className} relative flex items-center w-full border `}
      >
        ...
        />
        {isError && (
          <span className="absolute animate-slide-up -bottom-5 left-0 text-red-500 text-sm">
